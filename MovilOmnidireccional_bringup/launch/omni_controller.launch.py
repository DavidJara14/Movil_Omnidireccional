...
def generate_launch_description():
    ...
    gazebo = ExecuteProcess(
        ...
        get_package_share_directory('MovilOmnidireccional_bringup'),'world','test_w_1.world')],
            output='screen'
        )
    package_path = os.path.join( get_package_share_directory('MovilOmnidireccional_description') )

    xacro_file = os.path.join( package_path , 'urdf', 'omnidirectional_X3_controler.xacro' )
    rviz_config_path = os.path.join( package_path , 'rviz', 'yahboomcar_X3.rviz' )
